...
func (in *ClusterPolicySpec) DeepCopyInto(out *ClusterPolicySpec) {
	*out = *in
	...
	in.GPUManager.DeepCopyInto(&out.GPUManager)
	in.GPUAdmission.DeepCopyInto(&out.GPUAdmission)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GPUAdmissionSpec) DeepCopyInto(out *GPUAdmissionSpec) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GPUAdmissionSpec.
func (in *GPUAdmissionSpec) DeepCopy() *GPUAdmissionSpec {
	if in == nil {
		return nil
	}
	out := new(GPUAdmissionSpec)
	in.DeepCopyInto(out)
	return out
}
